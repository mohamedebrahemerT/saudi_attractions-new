<!-- <h1 class="pull-left">Confirmation Approved Mail</h1>
        ...
        @foreach($tickets_id as $ticket_id)
                <p>Ticket Number: {!! $ticket_id->ticket_number !!}</p>
        @endforeach -->
                                                                ...
                                                                <tr>
                                                                        ...
                                                                        <td width="460" style="border-collapse:collapse;padding: 0;">
                                                                                <table border="0" cellspacing="0" style="border-collapse:collapse;">
                                                                                        ...
                                                                                        <tr>
                                                                                                <td style="border-collapse:collapse;padding: 0;color: #444444;font-size: 14px;">{!! $event_location !!}</td>
                                                                                        </tr>
                                                                                        </tbody>
                                                                                </table>
                                                                        </td>
