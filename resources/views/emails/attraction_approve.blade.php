<!-- <h1 class="pull-left">Confirmation Approved Mail</h1>

        <p>Name: {!! $name !!}</p>
        <p>Mobile Number: {!! $mobile_number !!}</p>
        <p>Attraction Title: {!! $attraction_name !!}</p>
        <p>Attraction Location: {!! $attraction_location !!}</p>
        ...
        <table width="600" border="0" cellspacing="0" style="table-layout:fixed;border-collapse:collapse;width:600px;margin:auto;font-family: Helvetica,Arial,sans-serif;">
                                ...
                                <table border="0" cellspacing="0" bgcolor="#f0f0f0" style="border-collapse:collapse;">
                                        ...
                                        <tr>
                                                <td width="600" height="200" style="border-collapse:collapse;padding: 0;">
                                                        <div>
                                                                <img src="{{asset('/uploads/cover.jpg')}}" alt="cover" width="600" height="200" style="display: block;">
                                                        </div>
                                                </td>
                                        </tr>
                                        <tr>
                                ...
                                <table border="0" cellspacing="0" bgcolor="#f0f0f0" style="border-collapse:collapse;">
                                        ...
                                        <tr>
                                                ...
                                                <td width="520" height="170" bgcolor="#307dc1" style="border-collapse:collapse;width:520px;padding: 0;">
                                                        <div>
                                                                <img src="{!! asset($attraction_image) !!}" alt="cover" width="520" height="170" style="display: block;">
                                                        </div>
                                                </td>
                                                <td width="40" style="border-collapse:collapse;width:40px;padding: 0;"></td>
                                        </tr>
                                                                ...
                                                                <tr>
                                                                        ...
                                                                        <td width="360" style="border-collapse:collapse;padding: 0;">
                                                                                <table border="0" cellspacing="0" style="border-collapse:collapse;">
                                                                                        <tbody>
                                                                                        <tr>
                                                                                                <td style="border-collapse:collapse;padding: 0;color: #444444;font-size: 18px;font-weight:bold;">{!! $attraction_name !!}</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                                <td height="10" style="border-collapse:collapse;padding: 0;"></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                                <td style="border-collapse:collapse;padding: 0;color: #4dc181;font-size: 16px;">{!! $date !!}</td>
                                                                                        </tr>
                                                                                        </tbody>
                                                                                </table>
                                                                        </td>
                                                                ...
                                                                <tr>
                                                                        ...
                                                                        <td width="460" style="border-collapse:collapse;padding: 0;">
                                                                                <table border="0" cellspacing="0" style="border-collapse:collapse;">
                                                                                        <tbody>
                                                                                        <tr>
                                                                                                <td style="border-collapse:collapse;padding: 0;color: #999999;font-size: 14px;font-weight:bold;">ATTRACTION LOCATION</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                                <td height="5" style="border-collapse:collapse;padding: 0;"></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                                <td style="border-collapse:collapse;padding: 0;color: #444444;font-size: 14px;">{!! $attraction_location !!}</td>
                                                                                        </tr>
                                                                                        </tbody>
                                                                                </table>
                                                                        </td>
                                                                ...
                                                                <tr>
                                                                        ...
                                                                        <td width="200" style="border-collapse:collapse;padding: 0;">
                                                                                <table border="0" cellspacing="0" style="border-collapse:collapse;">
                                                                                        ...
                                                                                        <tr>
                                                                                                <td style="border-collapse:collapse;padding: 0;color: #444444;font-size: 14px;">{!! $ticket->number_of_tickets !!}</td>
                                                                                        </tr>

                                                                                        <tr>
                                                                                            <td style="border-collapse:collapse;padding: 0;color: #999999;font-size: 14px;font-weight:bold;">Ticket Type</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td height="5" style="border-collapse:collapse;padding: 0;"></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td style="border-collapse:collapse;padding: 0;color: #444444;font-size: 14px;">{!! $ticket->attraction_ticket['type']!!}</td>
                                                                                        </tr>
                                                                                        @endforeach
                                                                                        </tbody>
                                                                                </table>
                                                                        ...
                                                                        <td width="200" style="border-collapse:collapse;padding: 0;">
                                                                                <table border="0" cellspacing="0" style="border-collapse:collapse;">
                                                                                        ...
                                                                                        @foreach($tickets_id as $ticket_id)
                                                                                            ...
                                                                                            <tr>
                                                                                                <td style="border-collapse:collapse;padding: 0;color: #444444;font-size: 14px;"> {!! $ticket_id->ticket_number !!}</td>
                                                                                            </tr>
                                                                                        @endforeach
                                                                                        </tbody>
                                                                                </table>
                ...
                <tr>
                        <td bgcolor="#f0f0f0" width="600" align="center" style="border-collapse:collapse;color: #6d6d6d;font-size: 14px;font-weight: bold;padding: 0;">
                                <a href="http://www.jeddahattractions.com" title="" target="_blank" style="color: #4dc181;font-size: 11px;font-weight:bold;">WWW.JEDDAHATTRACTIONS.COM</a></td>
                </tr>
                <tr>
                ...
                <tr>
                        <td bgcolor="#f0f0f0" style="border-collapse:collapse;padding: 0;">
                                <table border="0" cellspacing="0" style="border-collapse:collapse;">
                                        <tbody>
                                        <tr>
                                                @foreach($attraction_social as $social)
